...
plt.legend()
plt.savefig('../../figs/iir/ee18btech11029_cheb_lp_analog.eps')
plt.savefig('../../figs/iir/ee18btech11029_cheb_lp_analog.pdf')
subprocess.run(shlex.split("termux-open ../../figs/iir/ee18btech11029_cheb_lp_analog.pdf"))
#else
plt.show()
