...
plt.grid()
plt.savefig('../../figs/iir/AnalogBandpass.eps')
plt.savefig('../../figs/iir/AnalogBandpass.pdf')
...
plt.grid()
plt.savefig('../../figs/iir/DigitalBandpass.eps')
plt.savefig('../../figs/iir/DigitalBandpass.pdf')
